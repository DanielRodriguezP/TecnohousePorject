...
function DescargarPlantilla() {
    $.ajax({
        url: sessionStorage.getItem("RutaActual") +'/Gastos/DescargarPlantilla',
        type: "GET",
        dataType: "JSON",
        data: null,
...
function CargarInformacionExcel() {
    try {
        ...
        $.ajax({
            url: sessionStorage.getItem("RutaActual") + 'Gastos/ValidarArchivo',
            type: "POST",
            dataType: "JSON",
            data: {
                Plantilla: file
...
function Home() {
    ...
    this.ConsultarRegistrosExitosos = function (MostrarMensajeDeGridVacio = 1, ValidarExitosos) {
        $.ajax({
            type: "POST",
            url: sessionStorage.getItem("RutaActual") +"/Gastos/ConsultarregistrosExitosos",
...
function ConsultarRegistrosconErrores(MostrarMensajeDeGridVacio = 1, activarMensaje) {
    $.ajax({
        type: "POST",
        url: sessionStorage.getItem("RutaActual") +"/Gastos/ConsultarErroresExcel",
        contentType: "application/json; charset=utf-8",
        dataType: "json",
        data: 0,
        success: function (data) {
