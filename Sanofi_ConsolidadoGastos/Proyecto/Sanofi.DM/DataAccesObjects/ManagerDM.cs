...
namespace Sanofi.DM.DataAccesObjects
{
    #region Enumerador
    /// <summary>
    ...
    internal class ManagerDM
    {
        ...
        public ManagerDM()
        {
            nomeCadenaBancoDoDados = "strConnectionSanofi";
            string cadena = ObtenerNombreCadenaBaseDatos(nomeCadenaBancoDoDados);
            baseDatos = new DatabaseProviderFactory().Create(cadena);
        }
